...
<body>
    <div class='container-xxl position-relative bg-light d-flex p-0'>
        ...
        <div class='content'>
            ...
            <div class="modal fade" id="modalEstudiante" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="Nombre" id="Nombre"
                                        placeholder="Ingrese el nombre del estudiante" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label for="Apellido">Apellido</label>
                                    <input type="text" name="Apellido" id="Apellido"
                                        placeholder="Ingrese el apellido del estudiante" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label for="FechaNacimiento">Fecha Nacimiento</label>
                                    <input type="date" name="FechaNacimiento" id="FechaNacimiento"
                                        placeholder="Ingrese la fecha de nacimiento del estudiante" class="form-control"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label for="Grado">Grado</label>
                                    <input type="text" name="Grado" id="Grado"
                                        placeholder="Ingrese el Grado del estudiante" class="form-control" required>
                                </div>
                            </div>
            ...
            <div class="modal fade" id="modalEditarEstudiante" tabindex="-1" aria-labelledby="editarEstudianteLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <form id="frm_editar_estudiantes">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="FechaNacimientoE" id="FechaNacimientoE"
                                        placeholder="Ingrese la fecha de nacimiento del estudiante"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="GradoE">Grado</label>
                                    <input type="text" name="GradoE" id="GradoE"
                                        placeholder="Ingrese el grado del estudiante" class="form-control" required>
                                </div>
                            </div>
                            <div class="modal-footer">
            ...
            <div class='container-fluid pt-4 px-3'>
                <div class="container d-flex flex-row justify-content-start">
                    <div>
                        <button type="button" class="btn btn-primary mb-4 mx-2" data-bs-toggle="modal"
                            data-bs-target="#modalEstudiante">
                            <i class="bi bi-person-check"></i> Nuevo Estudiante
                        </button>
                    </div>
                    <div>
                        <input onkeydown="if (event.keyCode === 13) buscarEstudiante(this.value)" style="width: 25rem;"
                            type="text" id="buscarEstudiante" class="form-control mb-4 mx-3"
                            placeholder="Buscar Estudiante">
                    </div>
                </div>

                <h6 style="text-align: center; color: #FFFFFF;" class='mb-4'> Lista de Estudiantes</h6>
