                        ...
                        <form id="frm_clases">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="Nombre" id="Nombre" placeholder="Ingrese el nombre de la clase" class="form-control" required>
                                </div>

                                <div class="form-group">
                                    <label for="Descripcion">Descripción</label>
                                    <input type="text" name="Descripcion" id="Descripcion" placeholder="Ingrese la Descripcion del curso" class="form-control" required>
                                </div>
                            </div>
